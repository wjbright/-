...
export const article = {
  ...
  date: '2024-03-01',
  title: 'Everything you need to know about Mono Repos',
  description:
    'Lorem markdownum, bracchia in redibam! Terque unda puppi nec, linguae posterior in utraque respicere candidus Mimasque formae; quae conantem cervice. Parcite variatus, redolentia adeunt. Tyrioque dies, naufraga sua adit partibus celanda',
}
...
variatus, redolentia adeunt. Tyrioque dies, naufraga sua adit partibus celand.
